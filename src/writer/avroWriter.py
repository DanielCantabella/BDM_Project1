...
def writeAvro(inputArg):
    ...
    if inputArg == "property":
        ...
        for index, fileUrl in enumerate(fileUrls):
            ...
            delete_hdfs_folder(HDFS_DIRECTORY+"avroFiles/"+outputFolderName + filenames[index]) # Allows to overwrite the files in HDFS. Comment if you don't want to overwrite.
            upload_memory_to_hdfs(memoryFile, HDFS_DIRECTORY+"avroFiles/"+outputFolderName + filenames[index] + ".avro")
